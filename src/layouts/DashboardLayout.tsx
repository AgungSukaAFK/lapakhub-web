...
export default function DashboardLayout({
  ...
  return (
    <div className="flex h-screen w-full bg-slate-100">
      {/* Sidebar */}
      <div className="top-0 left-0 flex border-r border-r-black h-screen drop-shadow-md w-16 flex-col justify-between border-e bg-white">
        <div>
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col gap-4 container mx-auto mt-6 rounded-md overflow-y-auto px-4">
          <Breadcrumb />
          {children}
        </div>
      </div>
